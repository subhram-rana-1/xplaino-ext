  ...
  static async translate(
    ...
    try {
      ...
      if (responseUnauthenticatedUserId) {
        ...
        console.log('[TranslateService] Stored unauthenticated user ID:', responseUnauthenticatedUserId);
      }
        ...
        if (TokenRefreshService.isTokenExpiredError(response.status, errorData)) {
          ...
          try {
            ...
            if (retryResponseUnauthUserId) {
              ...
              console.log('[TranslateService] Stored unauthenticated user ID from retry:', retryResponseUnauthUserId);
            }
