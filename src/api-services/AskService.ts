  ...
  static async ask(
    ...
    try {
      ...
      if (responseUnauthenticatedUserId) {
        ...
        console.log('[AskService] Stored unauthenticated user ID:', responseUnauthenticatedUserId);
      }
        ...
        if (TokenRefreshService.isTokenExpiredError(response.status, errorData)) {
          ...
          try {
            ...
            if (retryResponseUnauthUserId) {
              ...
              console.log('[AskService] Stored unauthenticated user ID from retry:', retryResponseUnauthUserId);
            }
